 ...
 * @version 1.0
 * @date 2021/12/4 4:19 下午
 */
@Data
public class OverViewAndFeasibleVo {
    ...
    public OverViewAndFeasibleVo(int dura,
                                 ...
                                 String hsl, String csl, String msl, double dtlxsjcs, double jllsjcs,
